...
$_lang['customrequest.configs_desc_extended'] = "Конфигурации выполняются в порядке сетки. Если есть две конфигурации, начинающиеся с одного и того же пути псевдонима, используется первая конфигурация. Вы можете изменить порядок конфигураций путем перетаскивания. Колонка 'Alias Path' отображается зеленым текстом, если она была создана на основе идентификатора ресурса. Он отображается синим цветом, если содержит правильное регулярное выражение.";
