...
- Use the right setlocale property to get the current locale

## [1.3.8] - 2022-12-07

### Added

- Use the alias from the resource uri field and fallback to makeUrl

### Fixed

- Remove superfluous beforeSubmit code

## [1.3.7] - 2022-12-06

### Added

- Duplicate configuration by button or context menu

## [1.3.6] - 2022-11-30

### Fixed

- Fix search in the resource combo of a configuration
